...
# MailNest 邮箱模式：temporary（临时邮箱）或 exclusive（独占邮箱）；默认 temporary。
MAIL_NEST_MODE = env_str("MAIL_NEST_MODE", "temporary")

# MailNest 项目代码；OpenAI/ChatGPT 默认 chatgpt001。独占模式无需填写。
